...
namespace kütüphaneler.Controllers
{
    public class CustomersController : Controller
    {
        private readonly ApplicationDbContext _context;
        private readonly IValidator<Customer> _customervalidator;
        public CustomersController(ApplicationDbContext context,IValidator<Customer> customerValidator)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Name,Address,City,Age")] Customer customer)
        {
